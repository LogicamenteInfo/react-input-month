...
var InputMonth = /*#__PURE__*/function (_React$Component) {
  ...
  function InputMonth(props) {
    ...
    if (Locales[_this.props.lang] === undefined) throw 'Language not implemented.';
    _this.state = {
      id: v4(),
      lang: _this.props.lang,
      locales: Locales[_this.props.lang],
      month: '',
      year: '',
  ...
  _proto.drawMonthButtons = function drawMonthButtons() {
    ...
    Object.keys(this.state.locales).filter(function (m) {
      ...
      mB.push( /*#__PURE__*/React.createElement("button", {
        key: i,
  ...
  _proto.drawYearButtons = function drawYearButtons() {
    ...
    var _loop = function _loop(i) {
      yB.push( /*#__PURE__*/React.createElement("button", {
        key: i,
  ...
  _proto.onInputChange = /*#__PURE__*/function () {
    var _onInputChange = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
